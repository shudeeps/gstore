 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2017 <a href="#">shudeeps</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="{{asset('vendor/plugins/morris/morris.min.js')}}"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('vendor/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
